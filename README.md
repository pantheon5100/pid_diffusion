...
This repository is the official implementation of the paper: [Physics Informed Distillation for Diffusion Models](https://openreview.net/forum?id=rOvaUsF996), accepted by Transactions on Machine Learning Research (TMLR).
