...
This repository is the official implementation of the paper: [Physics Informed Distillation for Diffusion Models](https://openreview.net/forum?id=xDTKRLyaNN), accepted by Transactions on Machine Learning Research (TMLR).
...
<img src="assets/imagenet64.png" alt="Overview" width="600" />
...
# Acknowledgments
This repository is based on [openai/consistency_models](https://github.com/openai/consistency_models) and [EDM](https://github.com/NVlabs/edm).
